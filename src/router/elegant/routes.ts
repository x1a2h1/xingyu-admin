            ...
            children: [
              {
                ...
                handle: { i18nKey: 'route.(base)_ads-slot-manage_batch', hideInMenu:true, title: '(base)_ads-slot-manage_batch' }
              },
              {
                ...
                handle: { i18nKey: 'route.(base)_ads-slot-manage_create',	hideInMenu:true, title: '(base)_ads-slot-manage_create' }
              }
            ]
          },
          {
